...
exports.TranslationErrorBoundary = void 0;
const react_1 = __importStar(require("react"));
const react_native_1 = require("react-native");
const DEFAULT_FALLBACK_TEXT = "An error occurred in the translation system.";
class TranslationErrorBoundary extends react_1.Component {
    constructor(props) {
        super(props);
    ...
    render() {
        if (this.state.hasError) {
            ...
            <react_native_1.Text style={{ color: "#FF0000" }}>
...
exports.TranslationErrorBoundary = TranslationErrorBoundary;
exports.default = TranslationErrorBoundary;
