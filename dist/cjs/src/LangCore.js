...
exports.PLURAL_RULES = exports.TranslationManager = exports.ICUMessageFormat = void 0;
...
class ICUMessageFormat {
    ...
    static getCurrencyForLanguage(language) {
        ...
        if (LocaleData_1.PRIMARY_COUNTRY[lang]) {
            const countryCode = LocaleData_1.PRIMARY_COUNTRY[lang];
...
exports.PLURAL_RULES = PLURAL_RULES;
const ORDINAL_RULES = {
    en: (n) => {
        const mod10 = n % 10;
        const mod100 = n % 100;
