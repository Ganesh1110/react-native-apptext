...
import { View, Text as RNText, StyleSheet, ScrollView, TouchableOpacity, SafeAreaView, StatusBar, Switch, } from "react-native";
import AppText, { AppTextProvider, LocaleProvider, useLang, RTLProvider, } from "react-native-text-kit";
const translations = {
    en: {
...
function DemoContent() {
    ...
    return (<View style={styles.container}>
      <View style={styles.toggleRow}>
        ...
        <Switch value={isDarkMode} onValueChange={setIsDarkMode} trackColor={{ false: "#767577", true: "#81C784" }} thumbColor={isDarkMode ? "#f5dd4b" : "#f4f3f4"}/>
      </View>
      ...
      <View style={styles.section}>
        ...
        <View style={styles.card}>
          <View style={styles.row}>
            <AppText animated animation={{ type: "fadeIn", duration: 500 }} variant="bodyMedium" color="#4CAF50">
              {t("fade_in")}
            </AppText>
          </View>
          <View style={styles.row}>
            <AppText animated animation={{ type: "bounceIn", duration: 600 }} variant="bodyMedium" color="#2196F3">
              {t("bounce")}
            </AppText>
          </View>
          <View style={styles.row}>
            <AppText animated animation={{ type: "typewriter", speed: 50 }} variant="bodyMedium" color="#FF9800" cursor>
              {t("typewriter_type")}
            </AppText>
          </View>
        </View>
      ...
      <View style={styles.section}>
        <View style={styles.buttonRow}>
          <TouchableOpacity style={styles.demoButton} onPress={() => changeLanguage(nextLang)}>
...
export default function App() {
    ...
    const [isDarkMode, setIsDarkMode] = useState(false);
    return (<SafeAreaView style={{ flex: 1, backgroundColor: isDarkMode ? "#121212" : "#F5F5F5" }}>
