...
const Row = ({ children }) => (<View style={{ flexDirection: "row", flexWrap: "wrap", gap: 8 }}>{children}</View>);
export default {
...
export const DisplayVariants = () => (<Container>
...
export const HeadlineVariants = () => (<Container>
...
export const TitleVariants = () => (<Container>
...
export const BodyVariants = () => (<Container>
...
export const LabelVariants = () => (<Container>
...
export const StyledText = () => (<Container>
...
export const Animations = () => (<Container>
...
export const Internationalization = () => (<Container>
    <Section title="i18n">
      <AppText>{`{{greeting}}`}</AppText>
      <AppText>{`You have {{count}} items`}</AppText>
    </Section>
  </Container>);
export const AllVariants = () => (<Container>
